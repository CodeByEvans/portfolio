  ...
  const timelineItems = [
    {
      ...
      detail:
        "Trabajo con el stack MERN, pero mi stack no me limita, siempre estoy buscando nuevas tecnologías con las que trabajar y hacer nuevos proyectos. Busco siempre la mejor opción para el proyecto sin importar lo que tenga quie aprender",
      icon: "💻",
      color: "cyan",
    },
    {
      ...
      description:
        "Estudiando desarrollo web full-stack con un bootcamp de la universidad de Helsinski",
      detail:
