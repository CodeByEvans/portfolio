...
export const AboutSection = () => {
  ...
  const timelineItems = [
    ...
    },
    {
      ...
      detail:
        "Full Stack Open es un bootcamp gratuito acréditado por la Universidad de Helsinki. Esto me permitió aprender tecnologías web modernas, como React y Next.js. Además, aprendí a trabajar con bases de datos relacionales, como MongoDB, y a gestionar proyectos de manera colaborativa utilizando Git.",
      icon: "🎨",
      color: "purple",
    },
    {
