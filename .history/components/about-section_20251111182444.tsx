...
export const AboutSection = () => {
  ...
  const timelineItems = [
    ...
    },
    {
      ...
      detail:
        "Full Stack Open es un bootcamp gratuito acréditado por la Universidad de Helsinki. Esto me permitió aprender tecnologías web modernas, herramientas de colaboración, bases de datos, despliegue y más lenguajes como Typescript.",
      icon: "🎨",
      color: "purple",
    },
    {
