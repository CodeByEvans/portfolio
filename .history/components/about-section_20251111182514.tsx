...
export const AboutSection = () => {
  ...
  const timelineItems = [
    ...
    },
    {
      ...
      detail:
        "Full Stack Open es un bootcamp gratuito acréditado por la Universidad de Helsinki. Esto me permitió aprender frameworks, herramientas de colaboración, bases de datos, CI/CD, testing y más lenguajes como Typescript.",
      icon: "🎨",
      color: "purple",
    },
    {
