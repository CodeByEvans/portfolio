...
export const AboutSection = () => {
  ...
  const timelineItems = [
    ...
    },
    {
      ...
      detail:
        "Full Stack Open es un bootcamp gratuito acréditado por la Universidad de Helsinki. Esto me permitió aprender frameworks, herramientas de colaboración, bases de datos, CI/CD, testing, desarrollo de APIs y mucho más. Aprendiendo a ser un desarrollador profesional.",
      icon: "🎨",
      color: "purple",
    },
    {
