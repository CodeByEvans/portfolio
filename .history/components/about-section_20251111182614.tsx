...
export const AboutSection = () => {
  ...
  const timelineItems = [
    ...
    },
    {
      ...
      detail:
        "Full Stack Open es un bootcamp gratuito acréditado por la Universidad de Helsinki. Aquí aprendí los fundamentos del desarrollo web, incluyendo HTML, CSS, JavaScript, frameworks, herramientas de colaboración, bases de datos, CI/CD, testing, desarrollo de APIs y mucho más.",
      icon: "🎨",
      color: "purple",
    },
    {
