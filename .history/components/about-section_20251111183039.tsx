  ...
  const timelineItems = [
    {
      ...
      detail:
        "Trabajo con el stack MERN, pero mi stack no me limita, siempre estoy buscando nuevas tecnologías con las que trabajar y hacer nuevos proyectos. Busco siempre la mejor opción para el proyecto sin importar lo que tenga que aprender",
      icon: "💻",
      color: "cyan",
    },
    {
      ...
      detail:
        "Full Stack Open es un bootcamp gratuito acréditado por la Universidad de Helsinki. Aquí aprendí desarrollo web moderno; frameworks, control de versiones, bases de datos, CI/CD, testing, desarrollo de APIs y mucho más.",
      icon: "🎓",
      color: "purple",
    },
    {
      ...
      detail:
        "Gracias a un curso del SEPE, aprendí a programar en entornos de desarrollo y a crear aplicaciones web con Java y Spring Boot. Esta fue mi puerta de entrada al mundo del desarrollo web.",
      icon: "🚀",
      color: "teal",
    },
  ];
