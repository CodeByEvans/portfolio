  ...
  const timelineItems = [
    {
      ...
      description: "Mis primeros pasos en el desarrollo web con Java",
      detail:
        "Gracias a un curso del SEPE aprendí a desarrollar aplicaciones web con Java y Spring Boot. Este fue mi punto de partida en la programación: entender la lógica, las bases del back-end y las buenas prácticas de desarrollo.",
      icon: "🚀",
      color: "teal",
    },
    {
      ...
      description: "Bootcamp acreditado por la Universidad de Helsinki",
      detail:
        "Durante este bootcamp aprendí desarrollo web moderno con tecnologías como React, Node.js, Express y MongoDB. Profundicé en control de versiones, testing, CI/CD, GraphQL, TypeScript y arquitectura de APIs. Una experiencia que consolidó mi perfil full stack.",
      icon: "🎓",
      color: "purple",
    },
    {
      ...
      description: "Desarrollando aplicaciones web modernas y escalables",
      detail:
        "Trabajo con el stack MERN, aunque mi enfoque es adaptable: elijo siempre las tecnologías que mejor se ajustan al proyecto. Me apasiona aprender herramientas nuevas, experimentar con arquitecturas y optimizar cada parte del proceso de desarrollo.",
      icon: "💻",
      color: "cyan",
    },
  ];
