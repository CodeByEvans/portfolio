...
export const AboutSection = () => {
  ...
  const timelineItems = [
    ...
    },
    {
      ...
      detail:
        "Full Stack Open es un bootcamp acreditado por la Universidad de Helsinki. Aquí aprendí desarrollo web moderno, control de versiones, bases de datos, testing y APIs.",
      icon: "🎓",
      color: "purple",
    },
    {
      ...
      detail:
        "Trabajo con el stack MERN, pero siempre estoy buscando nuevas tecnologías para mis proyectos. Busco la mejor opción para cada proyecto, aunque implique aprender algo nuevo.",
      icon: "💻",
      color: "cyan",
    },
  ];
