          ...
          <div className="relative bg-card border border-border rounded-2xl p-12 text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
                Estoy disponible para nuevos proyectos y colaboraciones. Hablemos sobre cómo puedo ayudarte a hacer
                realidad tu próxima idea.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" asChild>
                <Link href="https://linkedin.com/in/evans-lituma" target="_blank">
            ...
            <div className="pt-8 border-t border-border">
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-muted-foreground">
                <a href="mailto:evansjavierlr@gmail.com" className="hover:text-primary transition-colors">
