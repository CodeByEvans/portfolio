      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <Link href="/" className="text-xl font-mono text-primary font-bold inline-block">
              {"<CodeByEvans />"}
            </Link>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Full-Stack Developer especializado en React, TypeScript y Next.js. Creando experiencias web excepcionales.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link href="/cv" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                CV
              </Link>
            </nav>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border text-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} CodeByEvans. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
