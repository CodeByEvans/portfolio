...
export function Header() {
  ...
  return (
    <motion.header
      ...
      className={`mx-auto w-full border-b border-border/40 bg-background/70 backdrop-blur-md transition-all duration-300 ${
    ...
    >
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        {/* Navegación Desktop */}
        <nav className="border p-2 px-2 rounded-full">
