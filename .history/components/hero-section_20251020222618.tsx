          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl text-pretty">
                Especializado en crear aplicaciones web modernas y escalables con React, TypeScript y Next.js.
                Transformo ideas en productos digitales de alto rendimiento.
              </p>
            </div>
            ...
            <div className="relative aspect-square rounded-lg border border-border bg-card p-8">
              ...
              <div className="relative h-full flex flex-col justify-between font-mono text-sm">
                <div className="space-y-2">
                  ...
                  <div className="text-foreground">{"export const developer = {"}</div>
                  <div className="pl-4 text-foreground">{'  name: "CodeByEvans",'}</div>
                  <div className="pl-4 text-foreground">{'  role: "Full-Stack Developer",'}</div>
                  ...
                  <div className="pl-4 text-foreground">{'  passion: "Building great products"'}</div>
