          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-balance">
                ...
                <button
                  className="ml-2 rounded-full border border-primary/0 hover:border-primary/50 transition-colors w-[50px] h-[50px] p-0 overflow-hidden"
                  aria-label="Perfil de CodeByEvans"
                >
                  <Image
                    src="/me.jpg"
                    width={50}
