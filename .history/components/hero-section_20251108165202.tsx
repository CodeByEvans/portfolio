  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#1e293b_1px,transparent_1px),linear-gradient(to_bottom,#1e293b_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]">
        <motion.div
          className="absolute w-2 h-2 bg-blue-400 rounded-full pointer-events-none shadow-[0_0_10px_rgba(59,130,246,0.7),0_0_20px_rgba(59,130,246,0.5)]"
          initial={{ x: 0, y: 0, opacity: 0 }}
          animate={{
            x: ["0rem", "16rem", "16rem", "0rem"], // recorre horizontal
            y: ["0rem", "0rem", "16rem", "16rem"], // recorre vertical
            opacity: [0, 1, 1, 0.5], // parpadeo
          }}
          transition={{
            duration: 3,
            repeat: Infinity,
