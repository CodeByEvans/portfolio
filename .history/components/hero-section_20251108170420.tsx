...
export function HeroSection() {
  return (
    ...
    >
      ...
      <motion.div
        className="absolute w-3 h-3 bg-blue-400 rounded-full pointer-events-none shadow-[0_0_10px_rgba(59,130,246,0.8),0_0_20px_rgba(59,130,246,0.5)]"
        initial={{ x: 0, y: 0, opacity: 0 }}
        animate={{
          x: ["0rem", "0rem", "16rem", "16rem", "0rem"],
          y: ["0rem", "16rem", "16rem", "0rem", "0rem"],
          opacity: [0, 1, 1, 0.5, 0],
          scale: [0.8, 1.2, 1, 0.8, 0.8],
        }}
        transition={{
          duration: 5,
          repeat: Infinity,
