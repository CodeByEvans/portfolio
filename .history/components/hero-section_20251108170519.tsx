...
export function HeroSection() {
  return (
    ...
    >
      ...
      {/* 2. Rayito eléctrico animado */}
      {/* Rayito eléctrico horizontal */}
      <motion.div
        className="absolute h-0.5 bg-blue-400 pointer-events-none shadow-[0_0_10px_rgba(59,130,246,0.8),0_0_20px_rgba(59,130,246,0.5)]"
        initial={{ x: 0, y: 0, opacity: 0 }}
        animate={{
          x: ["0rem", "16rem", "16rem", "0rem"], // recorrido horizontal
          y: ["0rem", "0rem", "16rem", "16rem"], // recorrido vertical (ajusta según tu grid)
          opacity: [0, 1, 1, 0.5, 0],
          scaleX: [0.5, 1, 0.8, 1], // hace efecto de “chispa” dinámica
        }}
        transition={{
          duration: 5,
          repeat: Infinity,
