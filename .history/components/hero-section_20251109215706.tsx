      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 pt-8 lg:pt-0">
            <div className="flex items-center flex-wrap gap-3 text-sm md:text-base text-muted-foreground">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/30 bg-primary/10 text-primary font-medium">
                {"< Hello World />"}
              </div>

              {/* Guion o separador visual */}
