            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
              {stadistics.map((stat, index) => (
                <motion.figure
                  ...
                  className="flex flex-col items-center justify-center p-6 bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/30 rounded-2xl shadow-lg text-center"
                >
