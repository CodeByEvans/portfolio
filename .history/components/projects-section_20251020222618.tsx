...
const projects = [
  {
    title: "Clover Studio",
    description:
      "Plataforma completa de gestión para estudios creativos con sistema de proyectos, clientes y facturación integrada.",
    summary: "Landing page optimizada con Next.js enfocada en conversión y SEO",
    features: [
      "Diseño y desarrollo de landing page con Next.js y React",
      "Componentes reutilizables y escalables con TypeScript",
      "Backend con Node.js, MongoDB y REST APIs",
      "Optimizaciones de performance: image optimization, lazy loading",
    ],
    image: "/modern-creative-studio-dashboard.jpg",
    tags: ["Next.js", "React", "Tailwind CSS", "TypeScript", "MongoDB", "Node.js"],
  ...
  },
  {
    ...
    description: "Sistema de gestión de actividades mensuales con interfaz interactiva y APIs REST escalables.",
...
export function ProjectsSection() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const newIndex = Math.min(projects.length - 1, Math.floor(scrollProgress * projects.length))
  ...
  return (
    <section id="proyectos" ref={containerRef} className="relative" style={{ height: `${projects.length * 100}vh` }}>
                  ...
                  <div className="grid lg:grid-cols-2 gap-0">
                    ...
                    <div className="p-8 lg:p-12 flex flex-col justify-center space-y-6 bg-background/80 backdrop-blur-sm">
                      <div className="space-y-2">
                        ...
                        <h3 className="text-3xl lg:text-4xl font-bold text-balance">{project.summary}</h3>
                      </div>

                      <p className="text-muted-foreground leading-relaxed text-lg text-pretty">{project.description}</p>
                      ...
                      {project.url ? (
                        ...
                        <div className="text-sm text-muted-foreground italic">Próximamente disponible</div>
                      )}
                    </div>
                  </div>
                </Card>
