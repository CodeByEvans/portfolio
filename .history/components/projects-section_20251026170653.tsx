...
const projects = [
  {
    title: "Clover Studio",
    description:
      "Landing page desarrollada para una marca artesanal de velas aromáticas y wax melts. Creada con Next.js y Tailwind CSS para ofrecer una experiencia visual elegante, responsive y optimizada para SEO, aplicando buenas prácticas de desarrollo y tipado con TypeScript.",
