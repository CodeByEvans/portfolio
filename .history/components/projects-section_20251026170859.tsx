...
const projects = [
  {
    title: "Clover Studio",
    description:
      "Landing page desarrollada para una marca artesanal de velas aromáticas y wax melts.",
    summary:
      "Landing page elegante y responsive para una marca artesanal, construida con Next.js y Tailwind CSS.",
    features: [
