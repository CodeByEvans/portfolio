...
const projects = [
  {
    ...
    summary: "Landing page artesanal",
    features: [
              ...
              >
                ...
                >
                  <div className="grid lg:grid-cols-2 gap-0">
                    ...
                    <div className="relative min-h-[400px] lg:min-h-[400px] p-8 lg:p-12 flex flex-col items-center justify-start bg-black/10 gap-6">
                      {/* Logo arriba */}
                      <div className="w-32 h-32 lg:w-40 lg:h-40 flex items-center justify-center rounded-full overflow-hidden border-2 border-border/50 shadow-lg bg-white">
                        <Image
                          src={project.logo || "/placeholder.svg"} // Logo de Clover Studio
