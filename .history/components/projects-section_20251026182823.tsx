...
const projects = [
  ...
  {
    title: "AmandoAndo",
    description: "Plataforma de e-commerce de papelería cristiana",
    summary: "Arquitectura técnica escalable de e-commerce",
    features: [
      "Arquitectura de componentes escalables y reutilizables con TypeScript",
      "Backend full-stack con Next.js y MongoDB",
