                ...
                >
                  ...
                  >
                    <div className="grid lg:grid-cols-2 gap-0">
                      ...
                      <div className="relative lg:min-h-[600px] p-8 lg:p-12 flex flex-col items-center justify-start bg-black/10 gap-6">
                      ...
                      <div className="p-8 lg:p-12 flex flex-col justify-center space-y-6 bg-background/80 backdrop-blur-sm">
                        ...
                        <p className="text-muted-foreground leading-relaxed text-md lg:text-lg text-pretty hidden lg:block">
                          {project.description}
                        </p>
