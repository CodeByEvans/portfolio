                ...
                >
                  ...
                  >
                    <div className="grid lg:grid-cols-2 gap-0">
                      ...
                      <div className="relative lg:min-h-[600px] p-6 lg:p-8 flex flex-col items-center justify-start bg-black/10 gap-6">
                      ...
                      {/* Right side - Details */}
                      <div className="p-8 lg:p-8 flex flex-col justify-center space-y-6 bg-background/80 backdrop-blur-sm">
