...
export function ProjectsSection() {
  ...
  useEffect(() => {
    // Cargar Canvas y Scene solo en el cliente
    Promise.all([import("@react-three/fiber"), import("./3D/Scene")]).then(
      ([fiber, scene]) => {
        setThreeComponents({
          Canvas: fiber.Canvas,
          Scene: scene.Scene,
    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="w-full h-[600px] bg-gray-900 rounded-lg overflow-hidden mb-16">
          {ThreeComponents ? (
            <ThreeComponents.Canvas gl={{ antialias: false }}>
              <ThreeComponents.Scene />
