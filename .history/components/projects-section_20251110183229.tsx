      ...
      <section>
        <article className="flex gap-4">
          {stadistics.map((stat, index) => (
            <figure
              key={index}
              className="flex flex-col items-center border border-primary/30 bg-primary/10 text-primary font-medium"
            >
              <h1>{stat.value}</h1>
              <p>{stat.label}</p>
            </figure>
          ))}
          <figure className="flex flex-col items-center border border-primary/30 bg-primary/10 text-primary font-medium">
            <h1>1+</h1>
