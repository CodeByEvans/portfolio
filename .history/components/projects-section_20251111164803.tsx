    ...
    <section id="proyectos" className="relative" ref={ref}>
      <div className="text-center mb-12 px-4">
        <motion.span
          ...
          className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-primary font-medium backdrop-blur-sm"
        >
          {"< Proyectos />"}
        </motion.span>
        <motion.h2
          ...
          animate={isInView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.6, ease: "easeOut" }}
          className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text  mb-3"
        >
