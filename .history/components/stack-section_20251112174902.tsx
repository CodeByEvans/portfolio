...
const ParallaxItems = ({ children, baseVelocity }: ParallaxProps) => {
  ...
  return (
    <div className="overflow-hidden flex whitespace-nowrap text-2xl w-full bg-transparent">
...
export const Stack = () => {
  return (
    <section>
      ...
      <Card className="p-4 w-100 h-40 mx-auto">
        <div className="flex flex-col h-full justify-between items-center text-3xl overflow-hidden">
          ...
          <p className="text-base">Mi stack tecnologico de Frontend</p>
        </div>
      </Card>
    </section>
  );
