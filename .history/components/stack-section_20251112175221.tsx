...
export const Stack = () => {
  return (
    <section>
      ...
      <Card className="p-4 w-100 h-40 mx-auto px-0">
        <div className="flex flex-col h-full justify-between items-center text-3xl overflow-hidden">
          <h2>Frontend</h2>
          <ParallaxItems baseVelocity={-2}>{frontEnd}</ParallaxItems>
          <p className="text-base px-8 text-center">
            Empecé desarrollando con HTML, CSS y Javascript, pero rapidamente me
            interesé por frameworks más avanzados e interactivos como React.
            Esto me permitió hacer aplicaciones más eficientes y dinámicas, las
            cuales quise mejorar aun más con Next.js y TypeScript.
          </p>
        </div>
      </Card>
    </section>
