      ...
      <div className="grid grid-cols-2 md:grid-cols-2 gap-4 max-w-6xl mx-auto">
        ...
        <Card className="p-4 w-100 h-90 mx-auto px-0">
          <div className="flex flex-col h-full justify-between items-center text-3xl overflow-hidden gap-4">
            ...
            <ParallaxItems baseVelocity={-2}>{frontEnd}</ParallaxItems>
            <p className="text-base px-8 text-center">
              Después de dominar el lado visual, me empezó a picar la curiosidad
              por lo que pasaba “detrás del telón”. Aprendí Node.js y Express
              para crear mis propias APIs y manejar la lógica del servidor. Con
              el tiempo, me enfoqué en estructurar el código con buenas
              prácticas, seguridad con JWT y autenticación, y conecté todo con
              bases de datos reales usando ORMs como Prisma y herramientas
              modernas como Next.js API Routes.
            </p>
          </div>
        </Card>
        <Card className="p-4 w-100 h-90 mx-auto px-0">
