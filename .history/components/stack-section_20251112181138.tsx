      ...
      <div className="grid grid-cols-2 md:grid-cols-2 gap-4 max-w-6xl mx-auto">
        ...
        <Card className="p-4 w-100 h-90 mx-auto px-0">
          <div className="flex flex-col h-full justify-between items-center text-3xl overflow-hidden gap-4">
            ...
            <ParallaxItems baseVelocity={-2}>{frontEnd}</ParallaxItems>
            <p className="text-base px-8 text-center">
              Después de dominar el lado visual, me picó la curiosidad por lo
              que pasaba detrás del telón. Ahí fue donde entré al mundo del
              backend con Node.js y Express, aprendiendo a crear mis propios
              endpoints y gestionar bases de datos. Con el tiempo, aprendí a
              desarrollar mis APIs, modelaje de datos, autenticación, SEO,
              etc... Esto me ha permitido desarrollarme como desarrollador
              full-stack.
            </p>
          </div>
        </Card>
