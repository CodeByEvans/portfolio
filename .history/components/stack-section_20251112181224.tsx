        ...
        <Card className="p-4 w-100 h-90 mx-auto px-0">
          <div className="flex flex-col h-full justify-between items-center text-3xl overflow-hidden gap-4">
            ...
            <p className="text-base px-8 text-center">
              ...
              vivos. Empecé con MongoDB por su flexibilidad, y más adelante
              trabajé con PostgreSQL y MySQL para manejar estructuras más
              complejas. También he usado servicios en la nube como Supabase y
              AWS para desplegar y escalar proyectos, además de integrar
              almacenamiento en Cloud y CI/CD para mantener todo corriendo sin
              interrupciones.
            </p>
          </div>
        </Card>
