        ...
        <Card className="p-4 w-100 h-90 mx-auto px-0">
          <div className="flex flex-col h-full justify-between items-center text-3xl overflow-hidden gap-4">
            ...
            <p className="text-base px-8 text-center">
              ...
              con MongoDB y PostgreSQL. También he usado servicios en la nube
              como Supabase y AWS para desplegar y escalar proyectos, además de
              integrar almacenamiento en Cloud y CI/CD para mantener todo
