      ...
      <div className="grid grid-cols-2 md:grid-cols-2 gap-4 max-w-6xl mx-auto">
        ...
        <Card className="p-4 w-100 h-90 mx-auto px-0">
          <div className="flex flex-col h-full justify-between items-center text-3xl overflow-hidden gap-4">
            ...
            <ParallaxItems baseVelocity={-2}>{frontEnd}</ParallaxItems>
            <p className="text-base px-8 text-center">
              Siempre me ha gustado que mis proyectos tengan datos reales,
              vivos. Empecé con MySQL, era la base de datos que más facil se me
              hizo en un principio, y más adelante aprendí a trabajar también
              con MongoDB, PostgreSQL e incluso Supabase, aprovechando su
              potencial con el Real-Time API y demás. Veía que guardar imagenes
              y archivos pesados en la base de datos era un problema, y por eso
              aprendí a usar servicios Cloud, como AWS S3 y Cloudinary.
            </p>
          </div>
        </Card>
        <Card className="p-4 w-100 h-90 mx-auto px-0">
