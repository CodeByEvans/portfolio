        ...
        <Card className="p-4 w-100 h-90 mx-auto px-0">
          <div className="flex flex-col h-full justify-between items-center text-3xl overflow-hidden gap-4">
            ...
            <p className="text-base px-8 text-center">
              ...
              vivos. Empecé con MySQL, que fue la base de datos que más fácil se
              me hizo al principio, y con el tiempo aprendí a manejar también
              MongoDB, PostgreSQL y Supabase, aprovechando su Real-Time API y
              sus integraciones. Al notar que guardar imágenes y archivos
              pesados en la base de datos no era lo ideal, empecé a usar
              servicios en la nube como AWS S3 y Cloudinary. Más adelante, me
              metí con CI/CD para automatizar despliegues y mejorar mi flujo de
              desarrollo.
            </p>
          </div>
        </Card>
