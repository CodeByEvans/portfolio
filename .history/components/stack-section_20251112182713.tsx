  ...
  return (
    <section>
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 gap-4 max-w-6xl mx-auto">
        <Card className="p-4 w-100 mx-auto px-0">
        ...
        <Card className="p-4 w-100 mx-auto px-0">
          <div className="flex flex-col h-full justify-between items-center text-3xl overflow-hidden gap-4">
            ...
            <ParallaxItems baseVelocity={-2}>{frontEnd}</ParallaxItems>
            <p className="text-base px-8 text-center">
              Después de dominar el lado visual, me empezó a intrigar lo que
              pasaba detrás del telón. Así fue como entré al mundo del backend
              con Node.js y Express, aprendiendo a crear mis propios endpoints y
              conectar todo con bases de datos. Con el tiempo, fui profundizando
              en el modelado de datos, autenticación, SEO y la estructura de las
              APIs. Todo eso me ayudó a convertirme en un desarrollador
              full-stack más completo.
            </p>
          </div>
        </Card>
        <Card className="p-4 w-100 mx-auto px-0">
          <div className="flex flex-col h-full justify-between items-center text-3xl overflow-hidden gap-4">
            ...
            <ParallaxItems baseVelocity={-2}>{frontEnd}</ParallaxItems>
            <p className="text-base px-8 text-center">
              Siempre me ha gustado que mis proyectos trabajen con datos reales,
              vivos y dinámicos. Empecé con MySQL, que fue la base de datos que
              más fácil se me hizo al principio, y con el tiempo aprendí a
              manejar también MongoDB, PostgreSQL y Supabase, aprovechando su
              Real-Time API y sus integraciones. Al notar que guardar imágenes y
              archivos pesados en la base de datos no era lo ideal, empecé a
              usar servicios en la nube como AWS S3 y Cloudinary. Más adelante,
              me metí con CI/CD para automatizar despliegues y mejorar mi flujo
              de desarrollo.
            </p>
          </div>
        </Card>
        <Card className="p-4 w-100 mx-auto px-0">
          <div className="flex flex-col h-full justify-between items-center text-3xl overflow-hidden gap-4">
            ...
            <ParallaxItems baseVelocity={-2}>{frontEnd}</ParallaxItems>
            <p className="text-base px-8 text-center">
              Para mí, la clave está en mantener un flujo limpio y productivo.
              Uso Git y GitHub en cada proyecto, Zod para validaciones, i18next
              para traducción, y Playwright, Supertest y Jest para testing. Me
              gusta animar las interfaces con Framer Motion y Radix UI,
              trabajando la experiencia de usuario a la perfección a la vez que
              la accesibilidad. Nada de esto podría mantenerse sin unas buenas
              prácticas y buena documentación, así que hago de cada proyecto una
              experiencia unica.
            </p>
          </div>
        </Card>
