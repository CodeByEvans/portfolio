...
export function WhyHireMeSection() {
  ...
  useEffect(() => {
    const animateCarousel = (ref: React.RefObject<HTMLDivElement>, speed: number) => {
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          <Card className="p-8 bg-secondary/30 border-border hover:border-primary/50 transition-all">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Apasionado por las tecnologías de vanguardia. Siempre explorando las últimas herramientas y frameworks
              ...
              <div className="pt-4 space-y-3">
                ...
                <div className="overflow-hidden">
                  <div ref={carousel1Ref} className="flex gap-3 overflow-x-hidden" style={{ scrollBehavior: "auto" }}>
                ...
                {/* Carousel 2 */}
                <div className="overflow-hidden">
                  <div ref={carousel2Ref} className="flex gap-3 overflow-x-hidden" style={{ scrollBehavior: "auto" }}>
                ...
                {/* Carousel 3 */}
                <div className="overflow-hidden">
                  <div ref={carousel3Ref} className="flex gap-3 overflow-x-hidden" style={{ scrollBehavior: "auto" }}>
          ...
          <Card className="p-8 bg-secondary/30 border-border hover:border-primary/50 transition-all">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Experto en el ecosistema React, construyendo aplicaciones escalables con React 18, Next.js y TypeScript.
                He explorado certificados como Full Stack Open, un MOOC con créditos universitarios que profundiza en
                arquitectura de componentes moderna y patrones de diseño probados.
              </p>
          ...
          <Card className="p-8 bg-secondary/30 border-border hover:border-primary/50 transition-all">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Comprometido con la excelencia en cada proyecto. Trabajo mano a mano con los clientes para traducir sus
                necesidades en soluciones técnicas que superan expectativas.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                Flexible con comunicaciones en diferentes zonas horarias. Disponible para trabajar con clientes en
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <div className="px-4 py-2 bg-primary/10 border border-primary/30 rounded-lg">
                  ...
                  <span className="ml-2 text-sm font-medium text-primary">Europa</span>
                </div>
                <div className="px-4 py-2 bg-background border border-border rounded-lg">
                  <span className="text-sm font-mono text-muted-foreground">UK</span>
