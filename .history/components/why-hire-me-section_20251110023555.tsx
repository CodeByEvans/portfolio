...
import EarthCanvas from "./EarthModel";
// ----- TYPES -----
interface Tech {
  name: string;
        ...
        <Card className="p-8 md:p-12 bg-secondary/30 border-border">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-lg bg-primary/10 border border-primary/30 flex items-center justify-center flex-shrink-0">
                  {/* Opcional: puedes quitar el Globe2 */}
              ...
              {/* Aquí va el planeta 3D */}
              <div className="w-full h-96 md:h-[400px] relative">
                <EarthCanvas />
              </div>
            </div>

            {/* Imagen / Canvas del planeta */}
            <div className="relative w-full h-96 md:h-[400px] flex items-center justify-center">
              <EarthCanvas />
            </div>
          </div>
        </Card>
