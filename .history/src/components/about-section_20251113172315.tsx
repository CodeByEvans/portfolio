                  ...
                  <div className="flex-1">
                    ...
                    >
                      ...
                      >
                        {/* Frente de la carta */}
                        <div
                          className="text-center absolute inset-0 backface-hidden rounded-xl border border-gray-700 bg-gradient-to-br from-gray-800 to-gray-900 p-6 hover:border-cyan-500 transition-colors"
                        ...
                        >
                          <div className="flex flex-col md:flex-row items-center  md:text-left md:items-start gap-3 mb-4">
                            ...
                            <div>
                              <p className="text-cyan-500 text-xs md:text-sm font-mono mb-1">
                                {item.year}
                              </p>
                          ...
                          <div className="hidden md:block md:absolute bottom-4 right-4 text-gray-500 text-xs md:text-sm flex items-center gap-2">
