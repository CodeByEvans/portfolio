        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 pt-8 lg:pt-0">
            <div className="flex items-center flex-wrap gap-3 text-sm  text-muted-foreground">
              <div className="inline-flex items-center gap-2 px-2 py-1 md:px-3 border border-primary/30 bg-primary/10 text-primary font-medium text-xs md:text-sm">
                {"< Hello World />"}
              </div>
              ...
              <p className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-primary font-medium text-xs md:text-sm backdrop-blur-sm">
