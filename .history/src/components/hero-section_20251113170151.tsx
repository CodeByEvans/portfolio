        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <Image
              ...
              width={420}
              height={420}
              className="w-80 h-80 md:w-[420px] md:h-[500px] object-cover rounded-3xl shadow-2xl border border-primary/30 relative z-10 hover:rotate-1 hover:scale-[1.02] transition-transform duration-500 ease-out"
            />
          </motion.div>
        </div>
      </div>
